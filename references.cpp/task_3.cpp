...
using namespace std;
void exchangeRate(double, double, double, int &, int &);
...
int main()
{
    ...
    cout << "Dollar" << endl;
    cin >> d;
    exchangeRate(s, d, r, a_d, a_r);
    cout << "Количество денег в долларах= " << a_d << endl;
    cout << "Количество денег в рублях= " << a_r << endl;
    return 0;
}

void exchangeRate(double som, double ruble, double dollar, int &amount_dollar, int &amount_ruble)
{
